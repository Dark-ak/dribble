            ...
            <div className='flex items-center justify-between'>
                <div className='flex gap-2 md:gap-14'>
                    ...
                    <div className='md:flex gap-10 hidden'>
                        <p className='font-medium text-gray-500 text-lg cursor-pointer hover:text-[#EA4B8A]'>Inspirtaion</p>
                        <p className='font-medium text-gray-500 text-lg cursor-pointer hover:text-[#EA4B8A]'>Find Work</p>
                        <p className='font-medium text-gray-500 text-lg cursor-pointer hover:text-[#EA4B8A]'>Learn Design</p>
                        <p className='font-medium text-gray-500 text-lg cursor-pointer hover:text-[#EA4B8A]'>Go Pro</p>
                        <p className='font-medium text-gray-500 text-lg cursor-pointer hover:text-[#EA4B8A]'>Hire Designer</p>
                    </div>
                </div>
                <div className='flex items-center gap-5'>
                    ...
                    <div className='text-gray-400 hidden md:relative '>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
                            <path fillRule="evenodd" d="M7.5 6v.75H5.513c-.96 0-1.764.724-1.865 1.679l-1.263 12A1.875 1.875 0 0 0 4.25 22.5h15.5a1.875 1.875 0 0 0 1.865-2.071l-1.263-12a1.875 1.875 0 0 0-1.865-1.679H16.5V6a4.5 4.5 0 1 0-9 0ZM12 3a3 3 0 0 0-3 3v.75h6V6a3 3 0 0 0-3-3Zm-3 8.25a3 3 0 1 0 6 0v-.75a.75.75 0 0 1 1.5 0v.75a4.5 4.5 0 1 1-9 0v-.75a.75.75 0 0 1 1.5 0v.75Z" clipRule="evenodd" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 p-[2px] rounded-full bg-white absolute -bottom-3 -right-2 ">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.72 6.97a.75.75 0 1 0-1.06 1.06L10.94 12l-1.72 1.72a.75.75 0 1 0 1.06 1.06L12 13.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L13.06 12l1.72-1.72a.75.75 0 1 0-1.06-1.06L12 10.94l-1.72-1.72Z" clipRule="evenodd" />
                        </svg>

                    </div>
                    <button className='text-white bg-black px-6 py-3 rounded-full font-medium'>Sign Up</button>
                </div>
            </div>
